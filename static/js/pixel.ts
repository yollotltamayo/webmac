...
const cnvs = <HTMLCanvasElement>document.getElementById("imagenCanvas");
...
function cambiaColor() {
  const form = <HTMLFormElement>document.getElementById("colores");
  ...
  const color1 = <HTMLInputElement>document.getElementById("color1");
  const color2 = <HTMLInputElement>document.getElementById("color2");
